...
Рассмотрим движение материальной точки массой m, брошенной с начальной скоростью v₀ под углом α к горизонту. На тело действуют две силы: сила тяжести Fg = mg и сила сопротивления воздуха Fc.
...
Дальность полета: Наблюдается значительное уменьшение дальности полета. Для начальных параметров (v₀ = 50 м/с, α = 45°) снижение составляет approximately 30-40%.
...
Дальнейшее развитие модели может включать учет ветра, вращения Земли, изменения плотности воздуха с высотой, а также нестационарных эффектов в силе сопротивления.<img width="1005" height="647" alt="image" src="https://github.com/user-attachments/assets/73b9fffc-2fcf-4583-9d90-7078416c2f23" />
